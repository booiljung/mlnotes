...
* Understanding Machine Learning [Cambridge](http://www.cambridge.org/il/academic/subjects/computer-science/pattern-recognition-and-machine-learning/understanding-machine-learning-theory-algorithms#7fUpLU4ItLYx0bMj.97)
Shai Shalev-Shwartz, Shai Ben-Devid
* PRML: Pattern Recognition and Machine Learning [Springer](https://www.springer.com/kr/book/9780387310732)
Christopher Bishop
* The Elements of Statistical Learning [Stanford](https://web.stanford.edu/~hastie/ElemStatLearn/) Trevor Hastie, Robert Tibshirani, Jerome Friedman
* BRML: Bayesian Reasoning and Machine Learning [Amazon](https://www.amazon.com/Bayesian-Reasoning-Machine-Learning-Barber/dp/0521518148) David Barber
* A Probabilistic Theory of Pattern Recognition [Springer](http://www.springer.com/us/book/9780387946184) Luc Devroye
* Learning Bayesian Networks [Amazon](https://www.amazon.com/Learning-Bayesian-Networks-Richard-Neapolitan/dp/0130125342) Richard E. Neapolitan
* An Introduction to Statistical Learning with Applications in R [Gareth James](http://www-bcf.usc.edu/~gareth/ISL/) Gareth James, Daniela Witten, Trevor Hastie, Robert Tibshirani
* 기계학습 [한빛미디어](http://www.hanbit.co.kr/store/books/look.php?p_code=B4606522972) 오일석
...
* A Morphable Model For The Synthesis Of 3D Faces - 1999 [paper](http://gravis.dmi.unibas.ch/publications/Sigg99/morphmod2.pdf) Slow, Non-convex optimization problem
* Estimating 3D Shape and Texture Using Pixel Intensity, Edges, Specular Highlights, Texture Constraints and a Prior - 2005 [paper](http://gravis.dmi.unibas.ch/publications/CVPR05_Romdhani.pdf) Slow, Non-convex optimization problem
* 3D face reconstruction from a single image using a single reference face shape - 2011 [paper](https://www.ncbi.nlm.nih.gov/pubmed/21193812) 2.5D, Non-convex optimization problem, Difficulty.
